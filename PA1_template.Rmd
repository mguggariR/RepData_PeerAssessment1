...
```
Daily mean of the total steps taken is `r dailyMean` and the median is `r dailyMedian`.
...
```
There were `r naCount` missing values in original data set.  
...
The mean and median of this modified data are mean= `r ModdailyMean` and median= `r ModdailyMedian`  
